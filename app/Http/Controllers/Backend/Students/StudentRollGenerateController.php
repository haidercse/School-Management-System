...
class StudentRollGenerateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.students.roll-generate.index',compact('years','classes'));
    }

    public function getStudent(Request $request){
        $allStudent = AssignStudent::with(['student'])->where('year_id',$request->year_id)->where('class_id',$request->class_id)->get();
     ...
     */
     ...
     public function searchedStudent(Request $request){
        ...
        return view('backend.pages.students.roll-generate.index',compact('students','years','classes','yr_id','cls_id'));
     }
    ...
    public function create()
    {
        ...
        return view('backend.pages.students.roll-generate.create',compact('years','classes','groups','shifts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('student-roll-generate.index')->with('success','student  has been added successfully');
    }
    ...
    public function edit($student_id)
    {
        ...
        $groups = StudentGroup ::all();
        $shifts = StudentShift::all();
        return view('backend.pages.students.roll-generate.edit',compact('student','years','classes','groups','shifts'));
    }
    ...
    public function update(Request $request, $student_id)
    {
        ...
        return redirect()->route('student-roll-generate.index')->with('success','student  has been updated successfully');
    }
    ...
    public function promotionStudent($student_id)
    {
        ...
        $groups = StudentGroup ::all();
        $shifts = StudentShift::all();
        return view('backend.pages.students.roll-generate.promotion',compact('student','years','classes','groups','shifts'));
    }
    /**
     * Show the form for editing the specified resource.
     * promotion student
    ...
    public function promotionStoreStudent(Request $request, $student_id)
    {
        ...
        return redirect()->route('student-roll-generate.index')->with('success','student  has been promoted successfully');
    }
    ...
    {
        $student = AssignStudent::with(['student','discount'])->where('student_id',$student_id)->first();
        // return view('backend.pages.students.roll-generate.pdf',compact('student'));
       $pdf = PDF::loadView('backend.pages.students.roll-generate.pdf',compact('student'));
       $pdf->stream('student-details.pdf');
